...
<Callout type="default" emoji="🚀">
  **NEW: Meta's DINOv3 Now Available!** We've integrated Meta's groundbreaking
  DINOv3 model for image feature extraction. [Try the DINOv3 demo
  →](/supported-tasks/image-feature-extraction) or [learn more about
...
<Callout type="info" emoji="ℹ️">
  This guide uses the latest version of <PackageName /> for optimal performance
  and compatibility.
</Callout>
