...
<Callout type="info" emoji="🌐">
  ESRI ArcGIS services are publicly available. No API key required for basic
...
<Callout type="warning" emoji="🛰️">
  Uses ESRI's World Imagery service by default. For custom ESRI services, ensure
  they support tile-based access.
</Callout>

<Callout type="info" emoji="📊">
  ESRI services provide high-resolution satellite imagery suitable for most AI
  analysis tasks including object detection, segmentation, and classification.
</Callout>
